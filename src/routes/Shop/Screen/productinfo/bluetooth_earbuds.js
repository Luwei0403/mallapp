...
class BluetoothEarbudsProduct extends Component {
  ...
  handleAddToCart = () => {
    ...
    Alert.alert('加入購物車成功', '已將藍牙耳機加入購物車');
  };
    ...
    return (
      <SafeAreaView style={styles.container}>
        <View style={styles.productContainer}>
          ...
          <Image
            source={productImages['bluetooth_earbuds.png']}
            style={styles.productImage}
          />
         
          <Text style={styles.productName}>藍牙耳機</Text>
        
          <Text style={styles.productDescription}>
            這款無線藍牙耳機讓你隨時隨地享受高品質音樂。無論是通勤、運動還是工作，它的便捷設計與卓越音效讓你輕鬆投入每一刻的音樂時光。
          </Text>

...
class TShirtProduct extends Component {
  ...
  handleAddToCart = () => {
    ...
    Alert.alert("加入購物車成功", "已將純棉T恤加入購物車");
  };
    ...
    return (
      <SafeAreaView style={styles.container}>
        <View style={styles.productContainer}>
          ...
          <Image
            source={productImages["tshirt.png"]}
            style={styles.productImage}
          />
          
          <Text style={styles.productName}>純棉T恤</Text>
          
          <Text style={styles.productDescription}>
            舒適純棉T恤，給你全天候的輕盈與透氣感。簡約的設計既百搭又時尚，適合任何場合穿著，是你衣櫥中的必備單品。
          </Text>
...
export default connect(mapStateToProps, mapDispatchToProps)(TShirtProduct);

...
class GamingKeyboardProduct extends Component {
  ...
  handleAddToCart = () => {
    ...
    Alert.alert('加入購物車成功', '已將電競炫彩鍵盤加入購物車');
  };
    ...
    return (
      <SafeAreaView style={styles.container}>
        <View style={styles.productContainer}>
          ...
          <Image
            source={productImages['gaming_keyboard.png']}
            style={styles.productImage}
          />
          
          <Text style={styles.productName}>電競炫彩鍵盤</Text>
          
          <Text style={styles.productDescription}>
            這款高性能電競鍵盤專為遊戲玩家設計，擁有快速響應與高耐用性。讓你在遊戲中無往不利，每次按鍵都能精確控制，助你輕鬆掌控全局。
          </Text>

...
class SmartSpeakerProduct extends Component {
  ...
  handleAddToCart = () => {
    ...
    Alert.alert('加入購物車成功', '已將智慧音響加入購物車');
  };
    ...
    return (
      <SafeAreaView style={styles.container}>
        <View style={styles.productContainer}>
          ...
          <Image
            source={productImages['smart_speaker.png']}
            style={styles.productImage}
          />
          
          <Text style={styles.productName}>智慧音響</Text>
          
          <Text style={styles.productDescription}>
            這款智慧音響不僅支持語音控制，更可以輕鬆掌控你的智能家居。高品質音效讓你隨時隨地享受音樂的樂趣，讓生活變得更加便捷與舒適。
          </Text>
          
          <Text style={styles.productPrice}>$4500</Text>

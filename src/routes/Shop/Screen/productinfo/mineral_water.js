...
class MineralWaterProduct extends Component {
  ...
  handleAddToCart = () => {
    ...
    Alert.alert("加入購物車成功", "已將天然礦泉水加入購物車");
  };
    ...
    return (
      <SafeAreaView style={styles.container}>
        <View style={styles.productContainer}>
          ...
          <Image
            source={productImages["mineral_water.png"]}
            style={styles.productImage}
          />
          
          <Text style={styles.productName}>天然礦泉水</Text>
          
          <Text style={styles.productDescription}>
            天然礦泉水經過多層次天然過濾，保留最原始的礦物質。每一口都帶來純淨的清新，讓你感受到大自然的恩賜，是日常補水的完美選擇。
          </Text>
